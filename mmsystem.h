//This is MinGW's mmsystem.h with some types altered to make it work
//with tiny c compiler.
#ifndef _MMSYSTEM_H
#define _MMSYSTEM_H
#if __GNUC__ >=3
...
MMRESULT WINAPI waveOutGetID(HWAVEOUT,LPINT);
...
MMRESULT WINAPI waveInGetID(HWAVEIN,LPINT);
...
MMRESULT WINAPI midiStreamOpen(LPHMIDISTRM,LPINT,DWORD,DWORD,DWORD,DWORD);
...
MMRESULT WINAPI midiOutGetID(HMIDIOUT,LPINT);
...
MMRESULT WINAPI midiInGetID(HMIDIIN,LPINT);
...
MMRESULT WINAPI joyGetThreshold(UINT,LPINT);
